...
class ThingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create thing" do
    assert_difference("Thing.count") do
      post things_url, params: { thing: { otherthing: @thing.otherthing, something: @thing.something } }
    end
  ...
  test "should update thing" do
    patch thing_url(@thing), params: { thing: { otherthing: @thing.otherthing, something: @thing.something } }
